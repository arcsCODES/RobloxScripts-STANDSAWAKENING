-- This UI library makes the GUI draggable especially if you are using mobile (the other one isn't draggable)
-- Founded the script by: greentownXVI
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/DenDenZZZ/Kavo-UI-Library/main/Kavo.lua"))()

local Window = Library.CreateLib("STANDS AWAKENING KILLER GREENTOWNXVI", "DarkTheme")
...
PlrSection:NewToggle("30S TS", "Time Stop for 30s [Left_Control]", function(state)
...
--15s TS changed to 30s. if the 30s cd doesn't work change it back to 15s
TsSoundsSection:NewButton("(OLD) TW OVA TS", "30s TS", function()
    local args = {30, "dioova"}
    game:GetService("ReplicatedStorage"):WaitForChild("Main"):WaitForChild("Timestop"):FireServer(unpack(args))
end)
--^ end of changing 15s to 30s ^

TsSoundsSection:NewButton("(OLD) JOTARO OVA TS", "30s TS", function()
    local args = {30, "jotaroova"}
    game:GetService("ReplicatedStorage"):WaitForChild("Main"):WaitForChild("Timestop"):FireServer(unpack(args))
end)

TsSoundsSection:NewButton("JSP TS", "30s TS", function()
    local args = {30, "jotaro"}
    game:GetService("ReplicatedStorage"):WaitForChild("Main"):WaitForChild("Timestop"):FireServer(unpack(args))
end)

TsSoundsSection:NewButton("SPTW TS", "30s TS", function()
    local args = {30, "P4"}
    game:GetService("ReplicatedStorage"):WaitForChild("Main"):WaitForChild("Timestop"):FireServer(unpack(args))
end)

TsSoundsSection:NewButton("TWOH TS", "30s TS", function()
    local args = {30, "diooh"}
    game:GetService("ReplicatedStorage"):WaitForChild("Main"):WaitForChild("Timestop"):FireServer(unpack(args))
end)

TsSoundsSection:NewButton("SHADOW DIO TS", "30s TS", function()
    local args = {30, "shadowdio"}
    game:GetService("ReplicatedStorage"):WaitForChild("Main"):WaitForChild("Timestop"):FireServer(unpack(args))
end)

TsSoundsSection:NewButton("TW TS", "30s TS", function()
    local args = {30, "theworldnew"}
    game:GetService("ReplicatedStorage"):WaitForChild("Main"):WaitForChild("Timestop"):FireServer(unpack(args))
end)

TsSoundsSection:NewButton("TWAU TS", "30s TS", function()
    local args = {30, "diego"}
    game:GetService("ReplicatedStorage"):WaitForChild("Main"):WaitForChild("Timestop"):FireServer(unpack(args))
end)
...
-- Scrips that me added
OtherSection:NewButton("BEBO MODS SCRIPT", "ButtonInfo", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/Bebo-Mods/BeboScripts/main/StandAwakening.lua"))()
end)

OtherSection:NewButton("UNCANNY BOSS SCRIPT", "ButtonInfo", function()
...
CreditsSection:NewButton("greentownXVI", "Made the UI and founder of the script.", function(txt)
    print(txt)
end)